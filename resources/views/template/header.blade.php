                        ...
                        <div class="header-element main-profile-user">
                            ...
                            <ul class="dropdown-menu pt-0 overflow-hidden dropdown-menu-end mt-1"
                                ...
                                <li><a class="dropdown-item"
                                        href="{{ route('my/profile') }}"><i
                                            class="ti ti-user-circle fs-18 me-2 op-7"></i>Profile</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('my/dashboard') }}"><i
                                            class="ti ti-inbox fs-18 me-2 op-7"></i>Dashboard</a></li>
                                <li><a class="dropdown-item border-block-end"
                                        href="{{ route('my/activities') }}"><i
                                            class="ti ti-clipboard-check fs-18 me-2 op-7"></i>Activities</a></li>
                                <li><a class="dropdown-item"
                                        href="{{ route('my/settings') }}"><i
